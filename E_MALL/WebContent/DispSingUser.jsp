			...
			<div class="row">
				...
				<div class="col-sm-4">
					...
					try
					{
						...
						System.out.println("successfully connected with example database");
						...
						out.println("<form action='DispSingUser.jsp' method='post'>");
						...
						out.println("<input type='submit' value='GET DATA' >");
						out.println("</form>");
					...
					{
						PreparedStatement st2=con.prepareStatement("select * from Customer where cid='"+cid+"'");
						...
						<form>
							<table width="1200">
								...
								<tr>
									...
									<td><left><%out.println(rs2.getString(1));%></left></td>
									<td><left><%out.println(rs2.getString(2));%></left></td>
									<td><left><%out.println(rs2.getString(3));%></left></td>
									<td><left><%out.println(rs2.getString(4));%></left></td>
									<td><left><%out.println(rs2.getString(5));%></left></td>
									<td><left><%out.println(rs2.getString(7));%></left></td>
									<td><leftr><%out.println(rs2.getString(8));%></left></td>
									<td><left><%out.println(rs2.getString(9));%></left></td>
									<td><left><%out.println(rs2.getString(10));%></left></td>
									<td><left><%out.println(rs2.getString(11));%></left></td>
								</tr>
								<%
									}
							}
