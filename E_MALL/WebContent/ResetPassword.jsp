...
<head>
    ...
    <title>ResetPassword | Net-Mall</title>
...
<body>
	<header id="header"><!--header-->
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="Account.jsp"><i class="fa fa-star"></i> Wishlist</a></li>
		...
		<div class="container">
			<div class="heading">
				<h3 class="style1">USER SETTINGS</h3>
			</div>
			<div class="row">
				<div class="col-sm-3">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><a href="UpdateUser.jsp">PERSONAL INFORMATION</a></h3>
						</div>
					</div>
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><a href="ResetPassword.jsp">RESET PASSWORD</a></h3>
						</div>
					</div>
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><a href="DeactAccount.jsp">DEACTIVATE ACCOUNT</a></h3>
						</div>
					</div>
				</div>
				<div class="col-sm-4">
					...
					<script>
					   ...
					   $("#rnpwd").blur(function()
					   {
						...
						<form action="ResetPasswordServlet" method="post">
							...
							<input type="password" placeholder="New Password" name="npwd"  id="npwd"/><p id="pd"></p>
							<input type="password" placeholder="Re-enter New Password" name="rnpwd"  id="rnpwd"/><p id="rpd"></p>
