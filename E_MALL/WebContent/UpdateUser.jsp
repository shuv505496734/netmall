...
<head>
    ...
    <title>Personal Info | Net-Mall</title>
				...
				<div class="col-sm-3">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><a href="UpdateUser.jsp">UPDATE PERSONAL INFO</a></h3>
						</div>
					</div>
					<div class="panel panel-default">
						<div class="panel-heading">
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form action="UpdateInfoServlet" method="post">
							...
							<input type="text" placeholder="First Name" name="fname" value='${fname}'/>
							...
							<input type="text" placeholder="Street" name="street" value='${street}'/>
							<input type="text" placeholder="City" name="city" value='${city}'/>
							<input type="text" placeholder="State" name="state" value='${state}'/>
							<input type="text" placeholder="Zip" name="zip" value='${zip}'/>
